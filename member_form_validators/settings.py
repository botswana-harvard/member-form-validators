...
APP_NAME = 'member_form_validators'

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/1.11/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = '=cuz^2y^i!)!-wmyyq$)gr9od!t)pw2r7lz33y-iq%t#p85pwz'
...
INSTALLED_APPS = [
    ...
    'member_form_validators.apps.EdcMapAppConfig',
...
ROOT_URLCONF = 'member_form_validators.urls'
...
WSGI_APPLICATION = 'member_form_validators.wsgi.application'
